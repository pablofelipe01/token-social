    ...
    const checkNewPlayer = async () => {
        try {
            ...
            if(wallet instanceof SmartWallet && address && sdk) {
                ...
                setLoadingStatus("Checking Client balance...");
                ...
                if(workerBalance?.toNumber() === 0) {
                    ...
                    setLoadingStatus("No Client found...");
                    try {
                        // Set the status message and claim the worker and tokens with Engine
                        setLoadingStatus("Claiming Client Pass ...")
                        ...
                        // Set the status message
                        setLoadingStatus("Client Pass claimed...");
                    } catch (error) {
                        console.error(error);
            ...
            console.error("Error getting client balance");
            console.error(error);
        }
    };
